...
```
$ sudo cp certs/snakeoil_ca.crt /usr/local/share/ca-certificates/apache-ca-false_snakeoil_ca.crt
$ ls -l /usr/local/share/ca-certificates/apache-ca-false_snakeoil_ca.crt
-rw-r--r-- 1 root root 2061  2月 11 12:32 /usr/local/share/ca-certificates/apache-ca-false_snakeoil_ca.crt
