...
vary: Accept
etag: W/"1c7cb67cfc0857ae33c235524b761788"
cache-control: max-age=0, private, must-revalidate
content-security-policy: script-src 'self' 'unsafe-inline'; style-src 'self' 'unsafe-inline'
x-request-id: 43076508-8bd0-44f2-b88f-85d16dea351e
x-runtime: 0.001914
server-timing: start_processing.action_controller;dur=0.01, render_template.action_view;dur=0.04, process_action.action_controller;dur=0.50
content-length: 0
```