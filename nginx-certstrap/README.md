...
```
$ sudo cp certs/snakeoil_ca.crt /usr/local/share/ca-certificates/nginx-certstrap_snakeoil_ca.crt
$ ls -l /usr/local/share/ca-certificates/nginx-certstrap_snakeoil_ca.crt
-rw-r--r-- 1 root root 2061  2月 12 16:26 /usr/local/share/ca-certificates/nginx-certstrap_snakeoil_ca.crt
