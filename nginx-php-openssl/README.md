...
```
$ sudo cp certs/snakeoil_ca.crt /usr/local/share/ca-certificates/nginx-php-openssl_snakeoil_ca.crt
$ ls -l /usr/local/share/ca-certificates/nginx-php-openssl_snakeoil_ca.crt
