...
```
$ sudo cp certs/snakeoil_ca.crt /usr/local/share/ca-certificates/nginx-minica_snakeoil_ca.crt
$ ls -l /usr/local/share/ca-certificates/nginx-minica_snakeoil_ca.crt
-rw-r--r-- 1 root root 749  2月 12 23:37 /usr/local/share/ca-certificates/nginx-minica_snakeoil_ca.crt
