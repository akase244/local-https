...
```
$ sudo cp certs/snakeoil_ca.crt /usr/local/share/ca-certificates/nginx-easy-rsa_snakeoil_ca.crt
$ ls -l /usr/local/share/ca-certificates/nginx-easy-rsa_snakeoil_ca.crt
-rw-r--r-- 1 root root 2033  2月 11 00:51 /usr/local/share/ca-certificates/nginx-easy-rsa_snakeoil_ca.crt
