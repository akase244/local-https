...
```
$ sudo cp certs/snakeoil_Development_Root_CA.crt /usr/local/share/ca-certificates/nginx-pure-php-tls_snakeoil_Development_Root_CA.crt
$ ls -l /usr/local/share/ca-certificates/nginx-pure-php-tls_snakeoil_Development_Root_CA.crt
